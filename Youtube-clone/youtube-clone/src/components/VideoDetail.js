...
const VideoDetail = ({ info }) => {
    ...
    return (
        <>
            {/* For Mobile */}
            <div className='md:hidden mt-3 flex p-1 flex-col gap-3 info-box'>
                <div className="title font-medium text-xl">{title}</div>
                <div className="channel-action-bar gap-2 flex w-full items-center justify-around flex-col">
                    <div className='channel-section flex w-full mx-1 items-center justify-between'>
                        <div className='flex'>
                    ...
                    <div className="actions w-full flex justify-center items-center gap-2">
                        ...
                        <button className="share rounded-full py-2 px-4 bg-gray-200 flex items-center">
                            <span>Save</span>
                            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="pl-1 h-6 w-6 style-scope yt-icon" ><g className="style-scope yt-icon"><path d="M22,13h-4v4h-2v-4h-4v-2h4V7h2v4h4V13z M14,7H2v1h12V7z M2,12h8v-1H2V12z M2,16h8v-1H2V16z" className="style-scope yt-icon"></path></g></svg>
                        </button>
            ...
            {/* For Desktop */}
            <div className='hidden md:flex mt-3 flex-col gap-3 info-box'>
                <div className="title font-medium text-xl">{title}</div>
