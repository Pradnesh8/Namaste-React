...
const TabBar = () => {
    ...
    return (
        <div className='flex w-full scroll-smooth scroll-mt-2 py-2 items-center gap-1 overflow-x-auto fixed bg-white md:py-3 md:px-2 md:gap-3 md:w-full md:overflow-hidden z-20'>
