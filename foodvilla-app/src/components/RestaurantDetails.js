    ...
    return (
        ...
        <div className="flex items-start mt-2">
            ...
            <div className="flex flex-col w-full">
                <div className="flex justify-center items-center gap-3 bg-gray-400 py-4 text-dark">
                    <img className="h-32 w-auto p-1 object-cover" src={CDN_IMG_URL + restData?.cloudinaryImageId} alt={restData?.name} />
                    <div>
                ...
                <div className="p-6">
                    <div className="text-xl font-medium" data-testid="menu">Menu</div>
...

                                        {
                                            cartItems.find(({ id }) => id === menu_item.id)
                                                ...
                                                <span className="bg-green-300 py-1 px-2 rounded-md">
                                                    <button onClick={() => addToCart(menu_item)} data-testid="addMenuItem">Add</button>
                                                </span>
                                        }
                                    </div>
                                </div>
