...
const Cart = () => {
    ...
    return (
        <div className="m-5">
            <h1 className="text-3xl ml-3 font-bold">Cart</h1>
            {
                cartItems.length > 0 ?
                    <div className="px-4 mt-2 min-h-[80vh]">
                        {
                            cartItems.map((item) => {
                                return (
                                    <div className="flex gap-4 justify-between items-center my-2 shadow-md">
                                        <div className="flex items-center">
                                            <div className="h-fit relative">
                                                {
                                                    item?.cloudinaryImageId ?
                                                        <img className=" h-28 w-28" src={CDN_IMG_URL + item.cloudinaryImageId} alt="dish-image" />
                                                        :
                                            ...
                                            <div className="text-base font-semibold ml-16">{item.name}</div>
                                        </div>
                        ...
                        <div className="h-32 flex flex-col justify-around items-end p-5 w-full my-2 shadow-md text-xl font-bold">
                            ...
                            <button className="bg-green-400 px-6 py-2 rounded-md text-white">Checkout</button>
                        </div>
                    </div>
                    :
